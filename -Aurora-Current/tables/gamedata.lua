...
AU.tables["hunterpaging"] = {
  ["MELEE"] = "Wing Clip",
  ["RANGED"] = "Arcane Shot",
}

AU.tables["customcast"] = {
...
AU.tables["debuffs"]['Cone of Cold']={[0]=8.0,} -- Cone of Cold
