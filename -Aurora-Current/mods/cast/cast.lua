...
AU:NewModule('castbar', 2, 'PLAYER_LOGIN', function()
    AU.common.KillFrame(CastingBarFrame)

    local castBar = AU.lib.CreateCastBar('player')
    ...
    AU:NewCallbacks('castbar', callbacks)
end)
