...
function setup:GenerateDefaults()
    ...
    for i = 1, table.getn(frames) do
        ...
        local catSizes = frame.name..' Sizes'
        local catTextDisplay = frame.name..' Text Display'
        local catFonts = frame.name..' Fonts'
        local catColors = frame.name..' Colors'
        local catHealthBar = frame.name..' Health Bar'
        local catManaBar = frame.name..' Mana Bar'
        local catBuffsDebuffs = frame.name..' Buffs & Debuffs'
        local catIcons = frame.name..' Icons'
        local catCombat = frame.name..' Combat & Effects'
        table.insert(defaults.gui, {tab = 'unitframes', subtab = frame.key, catGeneral, catSizes, catTextDisplay, catFonts, catColors, catHealthBar, catManaBar, catBuffsDebuffs, catIcons, catCombat})
        if frame.key == 'player' then
            local catExtras = 'Player Extras'
            table.insert(defaults.gui[table.getn(defaults.gui)], catExtras)
        end
        ...
        defaults[frame.key..'ShowPortrait'] = {value = true, metadata = {element = 'checkbox', category = catGeneral, indexInCategory = 2, description = 'Show or hide the portrait', dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'PortraitMode'] = {value = '3D Model', metadata = {element = 'dropdown', category = catGeneral, indexInCategory = 3, description = 'Portrait display mode', options = {'3D Model', '2D Portrait', 'Class Icon'}, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'ShowLevel'] = {value = true, metadata = {element = 'checkbox', category = catGeneral, indexInCategory = 4, description = 'Show level text', dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'ShowName'] = {value = true, metadata = {element = 'checkbox', category = catGeneral, indexInCategory = 5, description = 'Show name text', dependency = {key = frame.key..'Enabled', state = true}}}
        if frame.key ~= 'player' then
            defaults[frame.key..'NameAbbreviation'] = {value = 'truncated', metadata = {element = 'dropdown', category = catGeneral, indexInCategory = 6, description = 'Name abbreviation mode', options = {'none', 'initials', 'truncated'}, dependency = {key = frame.key..'Enabled', state = true}}}
            defaults[frame.key..'NameMaxLength'] = {value = 14, metadata = {element = 'slider', category = catGeneral, indexInCategory = 7, description = 'Max name length (truncated mode)', min = 3, max = 20, step = 1, dependency = {{key = frame.key..'Enabled', state = true}, {key = frame.key..'NameAbbreviation', state = 'truncated'}}}}
        end
        defaults[frame.key..'Scale'] = {value = 1, metadata = {element = 'slider', category = catSizes, indexInCategory = 1, description = 'Frame scale', min = 0.5, max = 2, step = 0.05, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'PortraitSize'] = {value = 80, metadata = {element = 'slider', category = catSizes, indexInCategory = 2, description = 'Portrait size', min = 40, max = 120, step = 1, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'InfoBgWidth'] = {value = 120, metadata = {element = 'slider', category = catSizes, indexInCategory = 3, description = 'Name bar width', min = 60, max = 300, step = 1, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'InfoBgHeight'] = {value = 16, metadata = {element = 'slider', category = catSizes, indexInCategory = 4, description = 'Name bar height', min = 8, max = 30, step = 1, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'HealthBarWidth'] = {value = 120, metadata = {element = 'slider', category = catSizes, indexInCategory = 5, description = 'Health bar width', min = 60, max = 300, step = 1, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'HealthBarHeight'] = {value = 20, metadata = {element = 'slider', category = catSizes, indexInCategory = 6, description = 'Health bar height', min = 10, max = 50, step = 1, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'ManaBarWidth'] = {value = 120, metadata = {element = 'slider', category = catSizes, indexInCategory = 7, description = 'Mana bar width', min = 60, max = 300, step = 1, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'ManaBarHeight'] = {value = 12, metadata = {element = 'slider', category = catSizes, indexInCategory = 8, description = 'Mana bar height', min = 6, max = 30, step = 1, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'ShowHealthText'] = {value = true, metadata = {element = 'checkbox', category = catTextDisplay, indexInCategory = 1, description = 'Show health text', dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'ShowManaText'] = {value = true, metadata = {element = 'checkbox', category = catTextDisplay, indexInCategory = 2, description = 'Show mana text', dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'HealthTextFormat'] = {value = 'cur/max', metadata = {element = 'dropdown', category = catTextDisplay, indexInCategory = 3, description = 'Health text format', options = {'current', 'cur/max', 'none'}, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'HealthTextShowPercent'] = {value = false, metadata = {element = 'checkbox', category = catTextDisplay, indexInCategory = 4, description = 'Show health percentage', dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'HealthTextAbbreviate'] = {value = false, metadata = {element = 'checkbox', category = catTextDisplay, indexInCategory = 5, description = 'Abbreviate health numbers', dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'HealthTextAnchor'] = {value = 'left', metadata = {element = 'dropdown', category = catTextDisplay, indexInCategory = 6, description = 'Health text anchor', options = {'left', 'center', 'right'}, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'ManaTextFormat'] = {value = 'cur/max', metadata = {element = 'dropdown', category = catTextDisplay, indexInCategory = 7, description = 'Mana text format', options = {'current', 'cur/max', 'none'}, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'ManaTextShowPercent'] = {value = false, metadata = {element = 'checkbox', category = catTextDisplay, indexInCategory = 8, description = 'Show mana percentage', dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'ManaTextAbbreviate'] = {value = false, metadata = {element = 'checkbox', category = catTextDisplay, indexInCategory = 9, description = 'Abbreviate mana numbers', dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'ManaTextAnchor'] = {value = 'left', metadata = {element = 'dropdown', category = catTextDisplay, indexInCategory = 10, description = 'Mana text anchor', options = {'left', 'center', 'right'}, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'LevelTextFont'] = {value = 'font:FRIZQT__.TTF', metadata = {element = 'dropdown', category = catFonts, indexInCategory = 1, description = 'Level text font', options = media.fonts, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'LevelTextSize'] = {value = 10, metadata = {element = 'slider', category = catFonts, indexInCategory = 2, description = 'Level text size', min = 6, max = 20, step = 1, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'NameTextFont'] = {value = 'font:FRIZQT__.TTF', metadata = {element = 'dropdown', category = catFonts, indexInCategory = 3, description = 'Name text font', options = media.fonts, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'NameTextSize'] = {value = 10, metadata = {element = 'slider', category = catFonts, indexInCategory = 4, description = 'Name text size', min = 6, max = 20, step = 1, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'HealthTextFont'] = {value = 'font:FRIZQT__.TTF', metadata = {element = 'dropdown', category = catFonts, indexInCategory = 5, description = 'Health text font', options = media.fonts, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'HealthTextSize'] = {value = 10, metadata = {element = 'slider', category = catFonts, indexInCategory = 6, description = 'Health text size', min = 6, max = 20, step = 1, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'HealthPercentTextFont'] = {value = 'font:FRIZQT__.TTF', metadata = {element = 'dropdown', category = catFonts, indexInCategory = 7, description = 'Health percent text font', options = media.fonts, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'HealthPercentTextSize'] = {value = 10, metadata = {element = 'slider', category = catFonts, indexInCategory = 8, description = 'Health percent text size', min = 6, max = 20, step = 1, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'ManaTextFont'] = {value = 'font:FRIZQT__.TTF', metadata = {element = 'dropdown', category = catFonts, indexInCategory = 9, description = 'Mana text font', options = media.fonts, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'ManaTextSize'] = {value = 10, metadata = {element = 'slider', category = catFonts, indexInCategory = 10, description = 'Mana text size', min = 6, max = 20, step = 1, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'ManaPercentTextFont'] = {value = 'font:FRIZQT__.TTF', metadata = {element = 'dropdown', category = catFonts, indexInCategory = 11, description = 'Mana percent text font', options = media.fonts, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'ManaPercentTextSize'] = {value = 10, metadata = {element = 'slider', category = catFonts, indexInCategory = 12, description = 'Mana percent text size', min = 6, max = 20, step = 1, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'NameTextColor'] = {value = {1, 0.82, 0, 1}, metadata = {element = 'colorpicker', category = catColors, indexInCategory = 1, description = 'Name text color', dependency = {key = frame.key..'Enabled', state = true}}}
        if frame.key == 'target' or frame.key == 'targettarget' or frame.key == 'pettarget' then
            defaults[frame.key..'NameReactionColoring'] = {value = false, metadata = {element = 'checkbox', category = catColors, indexInCategory = 2, description = 'Use reaction coloring for name', dependency = {key = frame.key..'Enabled', state = true}}}
        end
        local colorIdx = (frame.key == 'target' or frame.key == 'targettarget' or frame.key == 'pettarget') and 3 or 2
        defaults[frame.key..'HealthTextColor'] = {value = {1, 1, 1, 1}, metadata = {element = 'colorpicker', category = catColors, indexInCategory = colorIdx, description = 'Health text color', dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'HealthPercentTextColor'] = {value = {1, 1, 1, 1}, metadata = {element = 'colorpicker', category = catColors, indexInCategory = colorIdx + 1, description = 'Health percent text color', dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'ManaTextColor'] = {value = {1, 1, 1, 1}, metadata = {element = 'colorpicker', category = catColors, indexInCategory = colorIdx + 2, description = 'Mana text color', dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'ManaPercentTextColor'] = {value = {1, 1, 1, 1}, metadata = {element = 'colorpicker', category = catColors, indexInCategory = colorIdx + 3, description = 'Mana percent text color', dependency = {key = frame.key..'Enabled', state = true}}}
        local colorModeOptions = (frame.key == 'player') and {'class', 'reaction', 'custom', 'mirror'} or {'class', 'reaction', 'custom'}
        defaults[frame.key..'HealthBarColorMode'] = {value = 'class', metadata = {element = 'dropdown', category = catColors, indexInCategory = colorIdx + 4, description = 'Health bar color mode', options = colorModeOptions, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'HealthBarCustomColor'] = {value = {0, 1, 0}, metadata = {element = 'colorpicker', category = catColors, indexInCategory = colorIdx + 5, description = 'Custom health bar color', dependency = {{key = frame.key..'Enabled', state = true}, {key = frame.key..'HealthBarColorMode', state = 'custom'}}}}
        defaults[frame.key..'PortraitBorderTexture'] = {value = 'portrait_border_edge', metadata = {element = 'dropdown', category = catColors, indexInCategory = colorIdx + 6, description = 'Portrait border texture', options = {'portrait_border_edge', 'portrait_border', 'portrait_border_base'}, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'FlipPortraitBorder'] = {value = (frame.key == 'target'), metadata = {element = 'checkbox', category = catColors, indexInCategory = colorIdx + 7, description = 'Flip portrait border horizontally', dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'PortraitBorderColor'] = {value = {1, 1, 1, 1}, metadata = {element = 'colorpicker', category = catColors, indexInCategory = colorIdx + 8, description = 'Portrait border color', dependency = {key = frame.key..'Enabled', state = true}}}
        if frame.key ~= 'pet' then
            defaults[frame.key..'PvPIconColor'] = {value = {1, 1, 1, 1}, metadata = {element = 'colorpicker', category = catColors, indexInCategory = colorIdx + 9, description = 'PvP icon color', dependency = {{key = frame.key..'Enabled', state = true}, {key = frame.key..'ShowPvPIcon', state = true}}}}
        end
        defaults[frame.key..'HealthBarTexture'] = {value = 'aurora_hpbar', metadata = {element = 'dropdown', category = catHealthBar, indexInCategory = 1, description = 'Health bar texture', options = {'aurora_hpbar', 'aurora_hpbar_sharp', 'aurora_hpbar_reversed', 'aurora_hpbar_sharp_reversed', 'white8x8'}, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'HealthBarFillDirection'] = {value = (frame.key == 'target') and 'RIGHT_TO_LEFT' or 'LEFT_TO_RIGHT', metadata = {element = 'dropdown', category = catHealthBar, indexInCategory = 2, description = 'Health bar fill direction', options = {'LEFT_TO_RIGHT', 'RIGHT_TO_LEFT'}, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'HealthBarSmoothTransition'] = {value = true, metadata = {element = 'checkbox', category = catHealthBar, indexInCategory = 3, description = 'Smooth health bar transition', dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'HealthBarEnablePulse'] = {value = false, metadata = {element = 'checkbox', category = catHealthBar, indexInCategory = 4, description = 'Enable health bar pulse', dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'HealthBarEnableCutout'] = {value = false, metadata = {element = 'checkbox', category = catHealthBar, indexInCategory = 5, description = 'Enable health bar cutout', dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'HealthBarPulseColor'] = {value = {1, 1, 1, 1}, metadata = {element = 'colorpicker', category = catHealthBar, indexInCategory = 6, description = 'Health bar pulse color', dependency = {{key = frame.key..'Enabled', state = true}, {key = frame.key..'HealthBarEnablePulse', state = true}}}}
        defaults[frame.key..'HealthBarCutoutColor'] = {value = {1, 0.2, 0.2, 1}, metadata = {element = 'colorpicker', category = catHealthBar, indexInCategory = 7, description = 'Health bar cutout color', dependency = {{key = frame.key..'Enabled', state = true}, {key = frame.key..'HealthBarEnableCutout', state = true}}}}
        defaults[frame.key..'ManaBarTexture'] = {value = 'aurora_hpbar', metadata = {element = 'dropdown', category = catManaBar, indexInCategory = 1, description = 'Mana bar texture', options = {'aurora_hpbar', 'aurora_hpbar_sharp', 'aurora_hpbar_reversed', 'aurora_hpbar_sharp_reversed', 'white8x8'}, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'ManaBarFillDirection'] = {value = (frame.key == 'target') and 'RIGHT_TO_LEFT' or 'LEFT_TO_RIGHT', metadata = {element = 'dropdown', category = catManaBar, indexInCategory = 2, description = 'Mana bar fill direction', options = {'LEFT_TO_RIGHT', 'RIGHT_TO_LEFT'}, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'ManaBarSmoothTransition'] = {value = true, metadata = {element = 'checkbox', category = catManaBar, indexInCategory = 3, description = 'Smooth mana bar transition', dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'ManaBarEnablePulse'] = {value = true, metadata = {element = 'checkbox', category = catManaBar, indexInCategory = 4, description = 'Enable mana bar pulse', dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'ManaBarEnableCutout'] = {value = false, metadata = {element = 'checkbox', category = catManaBar, indexInCategory = 5, description = 'Enable mana bar cutout', dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'ManaBarPulseColor'] = {value = {1, 1, 1, 1}, metadata = {element = 'colorpicker', category = catManaBar, indexInCategory = 6, description = 'Mana bar pulse color', dependency = {{key = frame.key..'Enabled', state = true}, {key = frame.key..'ManaBarEnablePulse', state = true}}}}
        defaults[frame.key..'ManaBarCutoutColor'] = {value = {1, 0.2, 0.2, 1}, metadata = {element = 'colorpicker', category = catManaBar, indexInCategory = 7, description = 'Mana bar cutout color', dependency = {{key = frame.key..'Enabled', state = true}, {key = frame.key..'ManaBarEnableCutout', state = true}}}}
        ...
        if frame.key ~= 'pet' then
            defaults[frame.key..'ShowPvPIcon'] = {value = true, metadata = {element = 'checkbox', category = catIcons, indexInCategory = 1, description = 'Show PvP icon', dependency = {key = frame.key..'Enabled', state = true}}}
            defaults[frame.key..'PvPIconSize'] = {value = 45, metadata = {element = 'slider', category = catIcons, indexInCategory = 2, description = 'PvP icon size', min = 20, max = 80, step = 1, dependency = {{key = frame.key..'Enabled', state = true}, {key = frame.key..'ShowPvPIcon', state = true}}}}
        end
        defaults[frame.key..'CombatGlowTextures'] = {value = 'Both', metadata = {element = 'dropdown', category = catCombat, indexInCategory = 1, description = 'Combat glow textures', options = {'Both', 'Portrait Only', 'Bar Only', 'None'}, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'CombatGlowColor'] = {value = {1, 0, 0, 1}, metadata = {element = 'colorpicker', category = catCombat, indexInCategory = 2, description = 'Combat glow color', dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'CombatGlowMaxAlpha'] = {value = 0.7, metadata = {element = 'slider', category = catCombat, indexInCategory = 3, description = 'Combat glow max alpha (portrait)', min = 0, max = 1, step = 0.05, dependency = {key = frame.key..'Enabled', state = true}}}
        defaults[frame.key..'CombatGlow2MaxAlpha'] = {value = 0.7, metadata = {element = 'slider', category = catCombat, indexInCategory = 4, description = 'Combat glow max alpha (bar)', min = 0, max = 1, step = 0.05, dependency = {key = frame.key..'Enabled', state = true}}}
        if frame.key == 'pet' then
            local catPetExtras = 'Pet Extras'
            table.insert(defaults.gui[table.getn(defaults.gui)], catPetExtras)
            defaults['petHappinessIconSize'] = {value = 22, metadata = {element = 'slider', category = catPetExtras, indexInCategory = 1, description = 'Happiness icon size', min = 8, max = 40, step = 2, dependency = {key = 'petEnabled', state = true}}}
        end
        if frame.key == 'player' then
            defaults['playerShowRestingZZZ'] = {value = true, metadata = {element = 'checkbox', category = 'Player Extras', indexInCategory = 1, description = 'Show resting ZZZ animation', dependency = {key = 'playerEnabled', state = true}}}
            defaults['playerRestingZZZColor'] = {value = {1, 1, 1, 1}, metadata = {element = 'colorpicker', category = 'Player Extras', indexInCategory = 2, description = 'Resting ZZZ color', dependency = {key = 'playerEnabled', state = true}}}
            defaults['playerShowEnergyTick'] = {value = true, metadata = {element = 'checkbox', category = 'Player Extras', indexInCategory = 3, description = 'Show energy tick indicator', dependency = {key = 'playerEnabled', state = true}}}
            defaults['playerEnergyTickColor'] = {value = {1, 1, 1, 1}, metadata = {element = 'colorpicker', category = 'Player Extras', indexInCategory = 4, description = 'Energy tick color', dependency = {key = 'playerEnabled', state = true}}}
            defaults['playerRestingGlowTextures'] = {value = 'Both', metadata = {element = 'dropdown', category = 'Player Extras', indexInCategory = 5, description = 'Resting glow textures', options = {'Both', 'Portrait Only', 'Bar Only', 'None'}, dependency = {key = 'playerEnabled', state = true}}}
            defaults['playerRestingGlowColor'] = {value = {.3, .82, 0, 1}, metadata = {element = 'colorpicker', category = 'Player Extras', indexInCategory = 6, description = 'Resting glow color', dependency = {key = 'playerEnabled', state = true}}}
            defaults['playerRestingGlowMaxAlpha'] = {value = 0.7, metadata = {element = 'slider', category = 'Player Extras', indexInCategory = 7, description = 'Resting glow max alpha (portrait)', min = 0, max = 1, step = 0.05, dependency = {key = 'playerEnabled', state = true}}}
            defaults['playerRestingGlow2MaxAlpha'] = {value = 0.7, metadata = {element = 'slider', category = 'Player Extras', indexInCategory = 8, description = 'Resting glow max alpha (bar)', min = 0, max = 1, step = 0.05, dependency = {key = 'playerEnabled', state = true}}}
        end
    end
