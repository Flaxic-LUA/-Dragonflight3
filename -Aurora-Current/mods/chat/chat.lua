...
AU:NewModule('chat', 1, function()
    ...
    for i = 1, NUM_CHAT_WINDOWS do
        ...
        if cf then
            AU.common.KillFrame(_G['ChatFrame'..i..'BottomButton'])
            AU.common.KillFrame(_G['ChatFrame'..i..'DownButton'])
            AU.common.KillFrame(_G['ChatFrame'..i..'UpButton'])

            local upBtn = AU.ui.PageButton(cf, 20, 20, 'ChatFrame'..i..'UpBtn', 'north', 8)
            ...
            local downBtn = AU.ui.PageButton(cf, 20, 20, 'ChatFrame'..i..'DownBtn', 'south', 8)
            ...
            local bottomBtn = AU.ui.PageButton(cf, 20, 20, 'ChatFrame'..i..'BottomBtn', 'south', 8)
    ...
    AU.common.KillFrame(ChatFrameMenuButton)

    local upBtn1 = _G['ChatFrame1UpBtn']
    local menuBtn = AU.ui.PageButton(UIParent, 20, 20, 'AuroraChatMenuButton', 'east', 8)
    ...
    AU:NewCallbacks('chat', callbacks)
end)
